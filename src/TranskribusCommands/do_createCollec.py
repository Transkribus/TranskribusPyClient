...
description = """create a Transkribus collection.
""" + _Trnskrbs_description

usage = """%s <colName> 
"""%sys.argv[0]

class DoCreateCollec(TranskribusClient):
...
if __name__ == '__main__':
    ...
    __Trnskrbs_basic_options(parser, DoCreateCollec.sDefaultServerUrl)
    ...
    # --- 
    doer = DoCreateCollec(options.server, proxies, loggingLevel=logging.INFO)
